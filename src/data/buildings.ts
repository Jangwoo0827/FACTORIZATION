...
export const BUILDING_DEFS: readonly BuildingDef[] = [
  ...
  { id: 'smelter', name: '제련로', kind: 'passive', w: 2, h: 2, color: 0xd9603b, height: 1.6, needsOre: false },
  { id: 'assembler', name: '조립기', kind: 'passive', w: 3, h: 3, color: 0x4a8fd4, height: 1.9, needsOre: false },
